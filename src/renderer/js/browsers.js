  ...
  for (let grup in grupAlumnesList) {
    for (let alumne in grupAlumnesList[grup].alumnes) {
      ...
      if (!document.getElementById(alumne + "-header")) {
        ...
        NormesWebInner.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe-americas" viewBox="0 0 16 16">
        ...
        historialWebInner.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock-history" viewBox="0 0 16 16">
      ...
      if (!alumneStatusButtonMain) {
        alumneStatusButtonMain = document.getElementById(
          alumne + "-status-button-main"
        );
